...
${CURRENT_SCRIPT_DIR}/tmp/bin/sampleapp01
...
cd ${CURRENT_SCRIPT_DIR}/libcentralizedresources
xargs rm < build/install_manifest.txt
rm -rf build

cd ${CURRENT_SCRIPT_DIR}/assets-module
xargs rm < build/install_manifest.txt
rm -rf build

cd ${CURRENT_SCRIPT_DIR}/sample-app-01
xargs rm < build/install_manifest.txt
rm -rf build
