...
set(THIS_CMAKE_MODULES_DIR ${CMAKE_CURRENT_LIST_DIR})
    ...
    foreach (_inFile ${_sources})
        ...
        if (_ARGS_USE_YAML)
            add_custom_command(OUTPUT ${_outFile}
                COMMAND ${PERL_EXECUTABLE} ${THIS_CMAKE_MODULES_DIR}/TranslateDesktopYaml.pl ${_inFile} ${_fileName} ${_translationDir}/${_fileName}[_.]*${_fileExt}.yaml >> ${_outFile}
                VERBATIM
